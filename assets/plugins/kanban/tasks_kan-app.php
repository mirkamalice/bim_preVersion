<script type="text/javascript">
    ...
    (function () {
        ...
        function task_kanban_init() {
            ...
            $total_comments = $this->admin_model->count_rows('tbl_task_comment', array('module' => 'tasks', 'module_field_id' => $v_task->task_id));
            $total_attachment = $this->admin_model->count_rows('tbl_attachments', array('module' => 'tasks', 'module_field_id' => $v_task->task_id));
            $text = null;
            $due_date = $v_task->due_date;
            $due_time = strtotime($due_date);
            $current_time = strtotime(date('Y-m-d'));
            $text .= '<a data-task-id="' . $v_task->task_id . '" style="word-wrap: break-word;" class="text-info" href="' . base_url() . 'admin/tasks/details/' . $v_task->task_id . '">' . clear_textarea_breaks($v_task->task_name) . '</a>';
