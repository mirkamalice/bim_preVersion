<script type="text/javascript">
    ...
    (function () {
        ...
        function leads_kanban_init() {
            ...
            $total_calls = total_rows('tbl_calls', array('leads_id' => $v_k_leads->leads_id));
            $total_meetings = total_rows('tbl_mettings', array('leads_id' => $v_k_leads->leads_id));
            $total_meetings = total_rows('tbl_task', array('leads_id' => $v_k_leads->leads_id));
            $total_comments = total_rows('tbl_task_comment', array('module' => 'tasks', 'module_field_id' => $v_k_leads->leads_id));
            $total_attachment = total_rows('tbl_attachments', array('module' => 'tasks', 'module_field_id' => $v_k_leads->leads_id));
            $text = null;
