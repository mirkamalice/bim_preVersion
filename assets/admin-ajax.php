<script language="javascript" type="text/javascript">
    ...
    $(document).on("change", function () {
        ...
        if (url) {
            $.ajax({
                url: base_url + "admin/common/" + url + '/' + user_id,
                type: "POST",
                data: {
                    name: value,
                },
    ...
    function get_related_moduleName(val, proposal) {
        var base_url = '<?= base_url() ?>';
        if (proposal) {
            var strURL = base_url + "admin/common/get_related_moduleName_by_value/" + val + '/' + proposal;
        } else {
            var strURL = base_url + "admin/common/get_related_moduleName_by_value/" + val;
        }
        var req = getXMLHTTP();
        if (req) {
            req.onreadystatechange = function () {
    ...
    function get_project_by_id(id) {
        ...
        var base_url = '<?= base_url() ?>';
        var strURL = base_url + "admin/common/get_project_by_client_id/" + id;
        var req = getXMLHTTP();
        if (req) {
            req.onreadystatechange = function () {
                if (req.readyState == 4) {
