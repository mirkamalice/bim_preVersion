...
class Login extends MY_Controller
{
    ...
    public function index()
    {
        ...
        if (isset($mark_attendance) && !empty($allow_geo_clock_in) && $allow_geo_clock_in == 'TRUE') {
            $this->form_validation->set_rules('lat', 'location', 'trim|required');
            $this->form_validation->set_rules('long', 'location', 'trim|required');
        }
