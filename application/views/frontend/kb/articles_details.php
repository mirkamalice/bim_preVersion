            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                if (!empty($all_kb_category)) {
                    foreach ($all_kb_category as $kb_category) {
                        ...
                        $total_kb = count(array($this->db->where(array('kb_category_id' => $kb_category->kb_category_id, 'status' => 1, 'for_all' => 'No'))->get('tbl_knowledgebase')->result()));
                        ?>
                                    ...
                                    if (!empty($v_files)):
                                        ...
                                        <li>
                                            ...
                                            <div class="mailbox-attachment-info">
                                                <a href="<?= base_url() ?>frontend/kb_download/<?= $articles_info->kb_id . '/' . $fKey ?>"
