...
<div class=" mt-lg">
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content" style="border: 0;padding:0;">
            ...
            <div class="tab-pane <?= $active == 4 ? 'active' : '' ?>" id="" style="position: relative;">
                <div class="panel panel-custom">
                    <div class="panel-body">
                        <?php if ($this->session->userdata('user_type') == 1) { ?>
                        <div id="panelChart5">
                            <div class="row panel-title pl-lg pb-sm" style="border-bottom: 1px solid #a0a6ad">
                                <?= lang('all') . ' ' . lang('leave_report') ?></div>
