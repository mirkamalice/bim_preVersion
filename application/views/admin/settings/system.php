            ...
            <section class="panel panel-custom">
                ...
                <div class="panel-body">
                            ...
                            <?php if ($this->session->userdata('user_type') == '1') { ?>
                                <div class="col-sm-1">
                                    <span data-toggle="tooltip" data-placement="top"
                                          title="<?= lang('new_currency'); ?>">
                                    </span>
                                    <a data-toggle="modal" data-target="#myModal"
                                       href="<?= base_url() ?>admin/settings/new_currency"
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <a href="<?= base_url() ?>admin/settings/all_currency"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <?php $options = array(
                                    ...
                                    '4' => lang('attendance_report') . ' 4',
                                    '5' => lang('attendance_report') . ' 5',
                                    '6' => lang('attendance_report') . ' 6',
                                    '7' => lang('attendance_report') . ' 7',
                                );
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= lang('allow_geo_clock_in') ?></label>
                            <div class="col-lg-6">
                                <div class="checkbox c-checkbox">
                                    <label class="needsclick">
                                        <input type="checkbox" <?php
                                        if (config_item('allow_geo_clock_in') == 'TRUE') {
                                            echo "checked=\"checked\"";
                                        }
                                        ?> name="allow_geo_clock_in" id="use_postmark">
                                        <span class="fa fa-check"></span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div id="postmark_config" <?php echo (config_item('allow_geo_clock_in') != 'TRUE') ? 'style="display:none"' : '' ?>>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?= lang('office') . ' ' . lang('location'); ?>
                                    <span
                                            class="text-danger">*</span></label>
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control inputText2"
                                               value="<?= set_value('office_location', config_item('office_location')); ?>"
                                               id="searchTextField" name="office_location">
                                        <div class="input-group-addon" id="get_location">
                                            <i title="Get Current Location" style="cursor: pointer;"
                            ...
                            <input type="hidden" class="form-control"
                                   value="<?= set_value('lat', config_item('office_lat')); ?>" name="office_lat"
                                   id="lat">
                            <input type="hidden" class="form-control"
                                   value="<?= set_value('long', config_item('office_long')); ?>" name="office_long"
                                   id="long">

                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?= lang('allowed') . ' ' . lang('distance') . ' ' . lang('for') . ' ' . lang('login'); ?>
                                    <span class="text-danger">*</span></label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control"
                                           value="<?= set_value('dist_from_office', config_item('allowed_radius')); ?>"
                                           name="allowed_radius" id="dist_from_office">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= lang('chat_interval_time') ?></label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" value="<?= config_item('chat_interval_time') ?>"
                                       name="chat_interval_time">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control"
                                       value="<?= config_item('recaptcha_secret_key') ?>" name="recaptcha_secret_key">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= lang('allow_weekend_excluded_from_leave') ?></label>
                            <div class="col-lg-6">
                                <div class="checkbox c-checkbox">
                                    <label class="needsclick">
                                        <input type="checkbox" <?php
                                        if (config_item('allow_weekend_excluded_from_leave') == 'TRUE') {
                                            echo "checked=\"checked\"";
                                        }
                                        ?> name="allow_weekend_excluded_from_leave">
                                        <span class="fa fa-check"></span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= lang('allow_custom_permission') ?></label>
                            <div class="col-lg-9">
                                <div class="checkbox c-checkbox">
                                    <label class="needsclick">
                                        <input type="checkbox" <?php
                                        if (config_item('allow_custom_permission') == 'TRUE') {
                                            echo "checked=\"checked\"";
                                        }
                                        ?> name="allow_custom_permission">
                                        <span class="fa fa-check"></span>
                                        By default login user showing as custom permission
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <select multiple="multiple" name="client_default_menu[]" style="width: 100%"
                                    ...
                                    <option value=""><?= lang('select') . ' ' . lang('client_default_menu_permission') ?></option>
                                    <?php
    ...
    function handle_errors(error) {
        switch (error.code) {
            case error.PERMISSION_DENIED:
                alert("To get your current location, you must allow location access");
                break;
