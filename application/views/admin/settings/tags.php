<?= message_box('success'); ?>
<?= message_box('error');
$edited = can_action('160', 'edited');
$deleted = can_action('160', 'deleted');
                                ...
                                <form method="post"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <button type="button" style="margin-right:1px;<?= $method_info->style ?>"
                    ...
                    <tr>
                        <td>
                            <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-default me_name"
...
<link href="<?php echo base_url() ?>assets/plugins/bootstrap-colorpicker/bootstrap-colorpicker.css" rel="stylesheet">
