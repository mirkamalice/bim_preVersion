            ...
            <div class="panel panel-custom" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form id="form" action="<?php echo base_url() ?>admin/settings/save_email_notification"
                        ...
                        <div class="form-group">
                            <label for="field-1"
                                   class="col-sm-3 control-label"><?= lang('projects') . ' ' . lang('email') ?>
                                : <span
                                        class="required">*</span></label>
                            
                            <div class="col-sm-5">
                                <input data-toggle="toggle" name="projects_email" value="1" <?php
                        ...
                        <div class="form-group">
                            <label for="field-1"
                                   class="col-sm-3 control-label"><?= lang('tasks') . ' ' . lang('email') ?>
                                : <span
                                        class="required">*</span></label>
                            
                            <div class="col-sm-5">
                                <input data-toggle="toggle" name="tasks_email" value="1" <?php
