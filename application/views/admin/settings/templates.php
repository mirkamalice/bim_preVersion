...
$email['hrm'] = array(
    "leave_request_email" => array("{SITE_NAME}", "{NAME}"), "leave_approve_email" => array("{SITE_NAME}", "{START_DATE}", "{END_DATE}"), "leave_reject_email" => array("{SITE_NAME}", "{START_DATE}", "{END_DATE}"), "overtime_request_email" => array("{SITE_NAME}", "{NAME}"), "overtime_approved_email" => array("{SITE_NAME}", "{DATE}", "{HOUR}"), "overtime_reject_email" => array("{SITE_NAME}", "{DATE}", "{HOUR}"), "payslip_generated_email" => array("{SITE_NAME}", "{NAME}", "{MONTH_YEAR}"), "advance_salary_email" => array("{SITE_NAME}", "{NAME}"), "advance_salary_approve_email" => array("{SITE_NAME}", "{AMOUNT}", "{DEDUCT_MOTNH}"), "advance_salary_reject_email" => array("{SITE_NAME}"), "award_email" => array("{SITE_NAME}", "{NAME}", "{AWARD_NAME}", "{MONTH}"), "new_job_application_email" => array("{SITE_NAME}", "{NAME}", "{JOB_TITLE}", "{EMAIL}", "{MOBILE}", "{COVER_LETTER}"), "call_for_interview" => array("{SITE_NAME}", "{NAME}", "{JOB_TITLE}", "{DESIGNATION}", "{DATE}", "{NOTE}"), "new_notice_published" => array("{SITE_NAME}", "{NAME}", "{TITLE}"), "new_training_email" => array("{SITE_NAME}", "{TRAINING_NAME}", "{ASSIGNED_BY}"), 'deposit_email' => array("{SITE_NAME}", "{AMOUNT}", "{ACCOUNT}", "{BALANCE}"), 'expense_request_email' => array("{SITE_NAME}", "{AMOUNT}", "{NAME}"), 'expense_approved_email' => array("{SITE_NAME}", "{AMOUNT}", "{NAME}"), 'expense_paid_email' => array("{SITE_NAME}", "{AMOUNT}", "{NAME}", "{PAID_BY}"), 'trying_clock_email' => array("{SITE_NAME}", "{IP}", "{NAME}", "{TIME}"), 'clock_in_email' => array("{SITE_NAME}", "{IP}", "{NAME}", "{TIME}"), 'clock_out_email' => array("{SITE_NAME}", "{IP}", "{NAME}", "{TIME}"), 'promotion_email' => array("{NAME}", "{SITE_NAME}", "{DESIGNATIONS}"), 'warning_email' => array("{NAME}", "{SITE_NAME}", "{DESCRIPTION}")
);
