        ...
        <form action="<?php echo base_url() ?>admin/settings/save_theme" enctype="multipart/form-data"
            ...
            <div class="panel panel-custom">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('sidebar_font_size') ?></label>
                        <div class="col-lg-2">
                            <div class="input-group">
                                <input type="text" name="sidebar_font_size" class="form-control"
                                       value="<?= config_item('sidebar_font_size') ?>">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('body_font_size') ?></label>
                        <div class="col-lg-2">
                            <div class="input-group">
                                <input type="text" name="body_font_size" class="form-control"
                                       value="<?= config_item('body_font_size') ?>">
                                <div class="input-group-addon">
                                    <a href="#">px</a>
                                </div>
                            </div>
                            ...
                            <div class="mb">
                                <div class="col mb">
                                    <div class="setting-color">
                                        <label data-load-css="<?php echo base_url(); ?>assets/css/bg-white.css">
                                            <input type="radio"
                                                   name="sidebar_theme"
                                                   value="bg-white" <?= $theme == 'bg-white' ? 'checked' : null ?>>
                                            <span class="icon-check" style="color: #0168fa"></span>
                                            <span class="split">
                                       <span class="color bg-white"></span>
                                       <span class="color bg-info-white"></span>
                                    </span>
                                            <span class="color bg-white"></span>
                                        </label>
                                    </div>
                                ...
                                <div class="col mb">
                                    <div class="setting-color">
                                        <label data-load-css="<?php echo base_url(); ?>assets/css/bg-dark.css">
                                            <input type="radio"
                                                   name="sidebar_theme"
                                                   value="bg-dark" <?= $theme == 'bg-dark' ? 'checked' : null ?>>
                                            <span class="icon-check"></span>
                                            <span class="split">
                                       <span class="color bg-dark bg-gray-dark"></span>
                                       <span class="color bg-dark bg-gray-dark"></span>
                                    </span>
...
<script>
    ...
    $(function () {
        $('#active_custom_color').on("click", function () {
