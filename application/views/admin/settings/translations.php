...
$edited = can_action('137', 'edited');
$deleted = can_action('137', 'deleted');
                    ...
                    <div class="pull-right" style="margin-right: 5px;">
                        <select class="form-control select_box" name="language">
                            <?php if (!empty($availabe_language)) : foreach ($availabe_language as $v_availabe_language) : ?>
                                <option value="<?= str_replace(" ", "_", $v_availabe_language->name) ?>">
                                    <?= ucwords($v_availabe_language->name) ?></option>
                            <?php endforeach; ?>
                            <?php endif; ?>
                        </select>
                    ...
                    if (!empty($active_language)) :
                        foreach ($active_language as $v_language) :
                            ...
                            <tr>
                                ...
                                ?>
                                <td class="">
                                    <?php if (!empty($edited)) { ?> <a data-toggle="tooltip"
