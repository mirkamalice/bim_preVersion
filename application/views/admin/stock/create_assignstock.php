...
<div class="btn-group pull-right btn-with-tooltip-group filtered" data-toggle="tooltip"
    ...
    <ul class="dropdown-menu group animated zoomIn" style="width:300px;">
        ...
        <li class="dropdown-submenu pull-left  " id="by_sub_category">
            ...
            <ul class="dropdown-menu dropdown-menu-left by_sub_category" style="">
                <?php
                ...
                <?php if (!empty($v_category_info)) {
                            ...
                            ?>
                <li class="filter_by" id="<?= $sub_category->stock_sub_category_id ?>" search-type="by_sub_category">
        ...
        <div class="tab-content bg-white">
            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : '' ?>" id="assign_task" style="position: relative;">
                <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data"
                            ...
                            <select required class="form-control select_box" style="width: 100%" name="user_id">
                                ...
                                <optgroup label="<?php echo $dept_name; ?>">
                                    ...
                                    <option value="<?php echo $v_employee->user_id; ?>" <?php
                                                                                                            ...
                                                                                                            ?>>
                                        <?php echo $v_employee->fullname . ' ( ' . $v_employee->designations . ' )' ?>
                                    </option>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
                                </optgroup>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?= lang('assign_quantity') ?><span class="required">
                                *</span></label>

                        <div class="col-sm-5">
                            <input required type="text" data-parsley-type="number" name="assign_inventory"
                                placeholder=" <?= lang('enter') . ' ' . lang('assign_quantity') ?>" class="form-control"
                                value="<?php
                    ...
                    <div class="btn-bottom-toolbar text-right">
                        ...
                        <button type="submit" id="sbtn" class="btn btn-sm btn-primary"><?= lang('updates') ?></button>
                        <button type="button" onclick="goBack()"
                            class="btn btn-sm btn-danger"><?= lang('cancel') ?></button>
                        <?php } else {
                            ?>
                        <button type="submit" id="sbtn" class="btn btn-sm btn-primary"><?= lang('save') ?></button>
                        <?php }
                            ?>
                    </div>
