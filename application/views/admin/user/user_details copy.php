...
<div class="row mt-lg">
    <div class="col-sm-2">
        <ul class="nav nav-pills nav-stacked navbar-custom-nav">
            ...
            <li class="<?= $active == 14 ? 'active' : '' ?>"><a href="#awardPoint_details"
                    data-toggle="tab"><?= lang('award_point') ?></a>
            </li>
    ...
    <div class="col-sm-10">
        <div class="tab-content" style="border: 0;padding:0;">
            ...
            <div class="tab-pane <?= $active == 14 ? 'active' : '' ?>" id="awardPoint_details"
                style="position: relative;">
                <?php $this->load->view('admin/user/user_awardpoints') ?>
            </div>
                        ...
                        <table class="table table-striped" id="Transation_DataTables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $this->db->where('user_id', $v_activity->user)->get('tbl_account_details')->row()->fullname; ?>
                                    </td>
