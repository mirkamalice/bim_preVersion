            ...
            <form class="form-horizontal" action="<?= base_url() ?>admin/quotations/add_form/<?php
                ...
                <div class="">
                    <div class="col-md-12 mb-lg">
                        <input type="text" class="form-control" name="quotationforms_title" autocomplete="off" value="<?= $quotationforms_info->quotationforms_title ?>" placeholder="<?= lang('form_title') ?>">
                    </div>
                </div>
                <!--WI_QUOTATION_TITLE-->
                <div class="">
                ...
                <input type="hidden" name="quotationforms_code" id="quotationforms_code" value='<?= $quotationforms_info->quotationforms_code ?>'>
            </form>
                    ...
                    fb = new Formbuilder({
                        ...
                        bootstrapData: [
                            ...
                            ?> {
                                        ...
                                        "field_options": {
                                            <?php if (!empty($field_options['options'])) { ?> "options": [
                                                    <?php
                                            ...
                                            <?php } else { ?> "size": "<?= $field_options['size']; ?>"
                                            <?php } ?>
                                        },
