<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        ...
        <form role="form" data-parsley-validate="" novalidate="" action="<?php echo base_url(); ?>admin/quotations/converted_to_invoice/<?= $quotations_info->quotations_id ?>" method="post" class="form-horizontal form-groups-bordered">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" value="<?php
                                                                                ...
                                                                                if (config_item('increment_invoice_number') == 'FALSE') {
                                                                                    ...
                                                                                    echo $this->quotations_model->generate_invoice_number();
                                                                                }
                                                                                ?>" name="reference_no">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input data-toggle="toggle" name="client_visible" value="Yes" <?php
                                                                                                    if (!empty($quotations_info->client_visible) && $quotations_info->client_visible == 'Yes') {
                                                                                                        echo 'checked';
                                                                                                    }
                        ...
                        <select name="item_select" class="selectpicker m0" data-width="100%" id="item_select" data-none-selected-text="<?php echo lang('add_items'); ?>" data-live-search="true">
                            ...
                            ?>
                                ...
                                if (!empty($item_created)) { ?>
                                    ...
                                    <option value="newitem" data-content="<span class='text-info'><?php echo lang('new_item'); ?></span>"></option>
                                <?php } ?>
                            <?php
                            }
                            ?>
                        ...
                        <tbody>
                            ...
                            <tr class="main">
                                ...
                                <td>
                                    ...
                                    <input type="text" data-parsley-type="number" min="0" name="unit_cost" class="form-control" placeholder="<?php echo lang('price'); ?>">
                                </td>
                                <td>
                                    <?php
                            ...
                            <?php
                            if (isset($quotations_info) || isset($add_items)) {
                                $i = 1;
