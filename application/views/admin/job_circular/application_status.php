<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        <form id="form" role="form" enctype="multipart/form-data"
            ...
            <div class="form-group send_email"
                 style="display: <?= ($job_application_info->application_status == 3 ? 'block' : 'none') ?>">
                <label class="control-label col-sm-3"><?= lang('note') ?><span
                            class="required">*</span></label>
                <div class="col-sm-8">
                    <textarea class="form-control interview_note" name="interview_note"><?php
                        if (!empty($job_application_info->interview_note)) {
                            echo $job_application_info->interview_note;
                        }
                        ?></textarea>
                </div>
            </div>
