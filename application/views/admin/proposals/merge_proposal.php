<?php
if (count(array($estimate_to_merge)) > 0) { ?>
    <div class="row">
                ...
                <?php foreach ($estimate_to_merge as $_inv) { ?>
                    ...
                    <div class="checkbox mb0 mt-sm">
                        ...
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" name="invoices_to_merge[]" value="<?php echo $_inv->estimates_id; ?>">
                            <span class="fa fa-check"></span><a href="<?php echo base_url() . 'admin/estimates/create/estimates_details/' . $_inv->estimates_id; ?>" data-toggle="tooltip" data-placement="top" data-title="<?php echo lang($_inv->status); ?>" target="_blank"><?php echo $_inv->reference_no; ?></a>
