...
<div class="panel panel-custom">
    ...
    <form enctype="multipart/form-data" id="update_client" data-parsley-validate="" novalidate=""
        ...
        <div class="panel-body">
            <label class="control-label col-sm-3"></label <div class="col-sm-12">
                ...
                <div class="tab-content bg-white">
                    ...
                    <div class="chart tab-pane active" id="general_compnay">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select name="currency" class="form-control select_box" style="width: 100%">
                    ...
                    <div class="chart tab-pane" id="contact_compnay">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">
                                <a href="#" onclick="fetch_lat_long_from_google_cprofile(); return false;"
                                    data-toggle="tooltip"
        ...
        $.ajax({
            ...
            if (response.status == 'success') {
                if (typeof(response.id) != 'undefined') {
                    ...
                    groups.prepend('<option selected value="' + response.id + '">' + response.name +
                        '</option>');
