            ...
            <a href="#/" class="navbar-brand">
                ...
                <div class="brand-logo-collapsed">
                    <img style="width: 100%;height: 48px;border-radius: 50px"
                        src="<?= base_url() . config_item('company_logo') ?>" alt="App Logo" class="img-responsive">
                </div>
            </a>
            <?php }
            ?>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu animated zoomIn">
                        <li>
                            <a href="<?= base_url('admin/client/create_client/new') ?>">
                                <?= lang('new') . ' ' . lang('client') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/user/create/edit_user/') ?>">
                        ...
                        <li>
                            <a href="<?= base_url('admin/projects/create/new') ?>">
                                <?= lang('new') . ' ' . lang('project') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/tasks/create/new') ?>">
                                <?= lang('new') . ' ' . lang('tasks') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/bugs/create/new') ?>">
                                <?= lang('new') . ' ' . lang('bugs') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/opportunities/create/new') ?>">
                                <?= lang('new') . ' ' . lang('opportunities') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/leads/create/new') ?>">
                                <?= lang('new') . ' ' . lang('leads') ?>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?= base_url('admin/invoice/createinvoice/create_invoice') ?>">
                        ...
                        <li>
                            <a href="<?= base_url('admin/estimates/create/edit_estimates') ?>">
                                <?= lang('new') . ' ' . lang('estimates') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('admin/tickets/create/edit_tickets/') ?>">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu animated zoomIn">
                        <?php
                            ...
                            ?>
                        <li>
                            <a href="<?= base_url() ?>admin/common/set_language/<?= $lang->name ?>"
                                title="<?= ucwords(str_replace("_", " ", $lang->name)) ?>">
                                <img src="<?= base_url() ?>asset/images/flags/<?= $lang->icon ?>.gif"
                                    alt="<?= ucwords(str_replace("_", " ", $lang->name)) ?>" />
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu animated zoomIn">
                        ...
                        <li class="user-body">
                            ...
                            <div class="col-xs-4 text-center">
                                <a
                                    href="<?= base_url('admin/user/user_details/' . $user_id) ?>"><?= lang('my_details') ?></a>
                            </div>
                            <div class="col-xs-4 text-center">
