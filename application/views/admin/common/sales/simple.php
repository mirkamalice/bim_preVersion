            ...
            <div class="d-header-inner clearfix">
                <table class="clearfix">
                    ...
                    <tr>
                        <td style="width: 50%; vertical-align: top;">
                            <div class="">
                                <strong class="text-uppercase" style="color: #003580; text-transform: uppercase"><?= $title ?></strong>
                        ...
                        <td style="width: 50%; vertical-align: top;">
                            <div class="d-right">
                                <div style="font-size:0;position:relative;width:114px;height:114px; margin-left:auto"> <?= (!empty($qrcode) ? $qrcode : '') ?></div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width: 40%; vertical-align: top;">
                            <div class="mr" style="text-align: right;">
