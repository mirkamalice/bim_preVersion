            ...
            <div class="d-header clearfix">
                <div class="d-header-inner clearfix">
                    <table class="clearfix">
                        <tr>
                            <td>
                                <h1 class="fancy-title text-uppercase mt-0 mb-5 pt-5" style="width: 50%; color: #003580; border-top: 15px solid #003580;"><?= $title ?></h1>
                            ...
                            <td style="vertical-align: top;">
                                <div class="d-header-brand " style="text-align: center;">
                                    <img style="width: 200px;height: 80px;" src=<?= $img ?> alt="">
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width : 52%">
                                <strong class="text-uppercase" style="color: #003580;">From:</strong>
                                ...
                                <table class="summary-table mb-5" style="text-align: right;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-uppercase font-700" style="color: #003580;"><?php echo $start_date[0]; ?>:</td>
                                            <td><?php echo $start_date[1]; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div class="mb-5">
                                    <div style="margin-left:auto ;font-size:0;position:relative;width:114px;height:114px;">
                                        <?= (!empty($qrcode) ? $qrcode : '') ?>
                                    </div>
                                </div>
                            </td>
