...
<div class="invoice-preview-inner clearfix panel panel-custom" style="font-family: 'Inter', sans-serif;">
    <div class="preview-main client-preview clearfix">
        ...
        <div class="d-header clearfix">
            ...
            <table class="clearfix" style="margin-bottom: 15px; font-size : 14px;">
                <tr>
                    <td style="width: 50%;">
                        <div>
        ...
        <div class="clearfix" style="margin-top: 15px; padding:0 30px;">
            <div class="row">
                <div class="col-xs-6"><?= ($sales_info->notes) ?></div>
                <div class="col-xs-6">
                    <table class="s-table">
