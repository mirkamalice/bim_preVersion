...
<div class="modal-body wrap-modal wrap">
    <form action="<?php echo base_url() ?>admin/performance/create_indicator/<?php
        ...
        <div class="row">
            <div class="col-sm-6 row">
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="form-group">
                        <label for="field-1" class=" col-sm-7 control-label"
                    ...
                    <div class="form-group">
                        <label for="field-1" class=" col-sm-7 control-label"><?= lang('administration') ?>
                            : </label>
                        <div class="col-sm-5">
                            <p class="form-control-static" style="text-align: justify;"><?php
                    ...
                    <div class="form-group">
                        <label for="field-1" class=" col-sm-7 control-label"><?= lang('presentation_skill') ?>
                            : </label>
                        <div class="col-sm-5">
                            <p class="form-control-static" style="text-align: justify;"><?php
                    ...
                    <div class="form-group">
                        <label for="field-1" class=" col-sm-7 control-label"><?= lang('quality_of_work') ?>
                            : </label>
                        <div class="col-sm-5">
                            <p class="form-control-static" style="text-align: justify;"><?php
            ...
            <div class="col-sm-6">
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="form-group">
                        <label for="field-1" class=" col-sm-7 control-label"><?= lang('professionalism') ?>
                            : </label>
                        <div class="col-sm-5">
                            <p class="form-control-static" style="text-align: justify;"><?php
                    ...
                    <div class="form-group">
                        <label for="field-1" class=" col-sm-7 control-label"><?= lang('critical_thinking') ?>
                            : </label>
                        <div class="col-sm-5">
                            <p class="form-control-static" style="text-align: justify;"><?php
                    ...
                    <div class="form-group">
                        <label for="field-1" class=" col-sm-7 control-label"><?= lang('conflict_management') ?>
                            : </label>
                        <div class="col-sm-5">
                            <p class="form-control-static" style="text-align: justify;"><?php
                    ...
                    <div class="form-group">
                        <label for="field-1" class=" col-sm-7 control-label"><?= lang('ability_to_meet_deadline') ?>
                            : </label>
                        <div class="col-sm-5">
                            <p class="form-control-static" style="text-align: justify;"><?php
