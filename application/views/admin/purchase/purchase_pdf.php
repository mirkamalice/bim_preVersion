...
<body>
    ...
    <table class="items">
        ...
        <tfoot>
            <tr class="total">
                ...
                <td><?= display_money($this->purchase_model->calculate_to('purchase_cost', $purchase_info->purchase_id)) ?>
                </td>
            </tr>
            <?php
            ...
            <tr class="total">
                ...
                <td> <?= display_money($this->purchase_model->calculate_to('discount', $purchase_info->purchase_id)) ?>
                </td>
            </tr>
            <?php endif;
            ...
            <tr class="total">
                ...
                <td><?= display_money($this->purchase_model->calculate_to('total', $purchase_info->purchase_id), $currency->symbol); ?>
                </td>
            </tr>
            <?php
            $paid_amount = $this->purchase_model->calculate_to('paid_amount', $purchase_info->purchase_id);
    ...
    <div class="panel panel-custom" style="margin-top: 20px">
        ...
        <table class="items" border="0" cellspacing="0" cellpadding="0">
            <thead>
                <tr>
                    <th class="unit"><?= lang('items') ?></th>
                    <?php
                        $invoice_view = config_item('invoice_view');
                        if (!empty($invoice_view) && $invoice_view == '2') {
                        ?>
                    <th class="unit"><?= lang('hsn_code') ?></th>
                    <?php } ?>
            ...
            <tbody>
                <?php
                    ...
                    ?>
                <tr>
                    <td class="unit"><?= $v_item->item_name ?></td>
                    <?php
                                $invoice_view = config_item('invoice_view');
                                if (!empty($invoice_view) && $invoice_view == '2') {
                                ?>
