...
if (is_numeric($payments_info->payment_method)) {
    $payment_method = get_row('tbl_payment_methods', array('payment_methods_id' => $payments_info->payment_method));
} else {
    $payment_method->method_name = $payments_info->payment_method;
}
    ...
    <div class="col-sm-5">
        <div class="panel panel-custom">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-lg-12"><?= lang('payment_method') ?> <span class="text-danger">*</span></label>
                    <div class="col-lg-12">
                        ...
                        <div class="details-container clearfix" style="margin-bottom:20px">
                            <div style="font-size:10pt;">
                                ...
                                <div>
                                    ...
                                    <div style="padding-top:25px">
                                        <div class="payment_details_border">
                                            <?= !empty($payment_method->method_name) ? $payment_method->method_name : '-' ?>
                                        </div>
                                            ...
                                            <tbody>
                                                <tr class="cbb">
                                                    <td style="padding: 10px 0px 10px 10px;" valign="top"><a
                                                            href="<?= base_url() ?>admin/purchase/purchase_details/<?= $payments_info->purchase_id ?>">
                                                            <?= $purchase_info->reference_no ?></a>
                                                    </td>
