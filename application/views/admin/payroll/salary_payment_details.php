        ...
        <h4 class="modal-title" id="myModalLabel"><?= lang('salary_payment_details') ?>
            <div class="pull-right">
                <a href="<?= base_url() ?>admin/payroll/send_payslip/<?= $salary_payment_info->salary_payment_id ?>"
                   class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" title=""
                   data-original-title="<?= lang('send_email') ?>"><span <i class="fa fa-envelope-o"></i></span></a>
                ...
                <button class="btn btn-xs btn-danger" type="button" data-toggle="tooltip" data-placement="top"
                        title="<?= lang('print') ?>" onclick="printDiv('printableArea')"><i
                        ...
                        <div style="margin-left: 20px;">
                            ...
                            <table class="table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                    <td><?= strftime(config_item('date_format'), strtotime($salary_payment_info->joining_date)) ?>
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <div class="panel panel-custom">
                ...
                <div class="panel-body">
                    ...
                    foreach ($salary_payment_details_info as $v_payment_details) :
                        ?>
                        <div class="">
                            <label for="field-1" class="col-sm-5 control-label"><strong><?php
                            ...
                            <div class="panel panel-custom">
                                ...
                                <div class="panel-body">
                                    ...
                                    foreach ($allowance_info as $v_allowance) :
                                        ?>
                                        <div class="">
                                            <label class="col-sm-6 control-label"><strong><?php echo $v_allowance->salary_payment_allowance_label ?>
                                                    : </strong></label>
                                            <p class="form-control-static"><?php
                            ...
                            <div class="panel panel-custom">
                                ...
                                <div class="panel-body">
                                    ...
                                    if (!empty($deduction_info)) : foreach ($deduction_info as $v_deduction) :
                                        ?>
                                        <div class="">
                                            <label class="col-sm-6 control-label"><strong><?php echo $v_deduction->salary_payment_deduction_label; ?>
                                                    : </strong></label>
                                            <p class="form-control-static"><?php
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if (!empty($salary_payment_info->fine_deduction)) : ?>
                            <div class="">
                                <label class="col-sm-6 control-label"><strong><?= lang('fine_deduction') ?> :
                                    </strong></label>
                                <p class="form-control-static"><?php
                        ...
                        <?php if (!empty($salary_payment_info->payment_type)) : ?>
                            <div class="">
                                <label class="col-sm-6 control-label"><strong><?= lang('payment_method') ?> :
                                    </strong></label>
                                <p class="form-control-static"><?php
                            ...
                            if (!empty($account_info)) {
                                ...
                                <div class="">
                                    ...
                                    <p class="form-control-static"><a
                                                href="<?= base_url() ?>admin/account/create_account"><?php echo $account_info->account_name; ?></a>
                                    </p>
                                </div>
                            <?php }
                        } ?>
