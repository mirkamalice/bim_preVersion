...
$edited = can_action('92', 'edited');
$deleted = can_action('92', 'deleted');
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                ...
                                ?>" class="form-control monthyear"
                                       name="payment_month" data-format="yyyy/mm/dd">
                            ...
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    if (!empty($v_employee->basic_salary)) {
                                        ...
                                        $new_salary = $basic_salary + $total_allowance + $total_amount + $total_award - $total_advance - $total_deduction;
                                        // get per day salary by total_working_days and sum total_present
                                        $per_day_salary = $new_salary / $total_working_days;
                                        $total_salary = $per_day_salary * $total_present[$v_employee->user_id];
                                        
                                        echo display_money($total_salary);
                                ...
                                <td>
                                    ...
                                    <?php } else {
                                        if (!empty($set_salary) && !empty($edited)) {
                                            ?>
                        ...
                        <div class="panel-body">
                            <div class="">
                                ...
                                if (!empty($total_hours_amount)) {
                                    ...
                                    $main = $employee_info->basic_salary + $allowance_info;
                                }
                                ?>"
                            ...
                            $main_salary = $main - $deduction_info;
                            $per_day_salary = $main_salary / $total_working_days;
                            $total_absent_salary = round($per_day_salary * $total_absent, 2);
                            ?>
                            <div class="">
                                <label class="control-label"><?= lang('total_deduction') ?> </label>
                                <input type="text" name="" disabled value="<?php
                                echo $deduction = $deduction_info + $advance_amount + $total_absent_salary;
                                ?>" class="salary form-control">
                            </div>
                            <input type="hidden" name="absent_deduction"
                                   value="<?= $total_absent_salary ?>"/>
                            <div class="">
                            ...
                            <input type="hidden" name="payment_amount" value="<?php echo $net_salary + $total_award; ?>"
                                   class="payment_amount form-control">
                            <!-- Hidden Employee Id -->
                            ...
                            <div class="">
                                <!-- Payment Type -->
                                <label class="control-label"><?= lang('payment_method') ?> <span class="required">
                                        *</span></label>
                            ...
                            <div class="mb-lg" id="postmark_config"
                                ...
                                <label class="control-label"><?= lang('select') . ' ' . lang('account') ?></label>
                                <div class="">
                                        ...
                                        if (!empty($account_info)) {
                                            foreach ($account_info as $v_account) : ?>
                                                <option value="<?= $v_account->account_id ?>"
                                                    <?= (config_item('default_account') == $v_account->account_id ? ' selected="selected"' : '') ?>>
                            ...
                            <td>
                                <table style="width: 300px; margin-left: 10px; margin-bottom: 10px; font-size: 13px;">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= strftime(config_item('date_format'), strtotime($staff_details->joining_date)) ?>
                                        </td>
                                    </tr>
                                </table>
                            </td>
