<form name="myform" role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form"
    ...
    <div class="<?php if (!isset($estimates_info) || (isset($estimate_to_merge) && count(array($estimate_to_merge)) == 0)) {
        echo ' hide';
    } ?>" id="invoice_top_info">
        ...
        <div class="col-sm-12">
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="<?= base_url('admin/estimates') ?>"><?= lang('all_estimates') ?></a>
                    </li>
                    <li class=""><a href="<?= base_url('admin/estimates/create') ?>"><?= lang('create_estimate') ?></a>
                    </li>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            ...
                                            $('.filter_by').on('click', function () {
                                                ...
                                                table_url(base_url + "admin/estimates/estimatesList/" +
