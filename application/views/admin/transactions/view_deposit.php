...
<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        <div class="panel-body form-horizontal">
            ...
            <div class="col-md-12 notice-details-margin">
                <div class="col-sm-4 text-right">
                    <label class="control-label"><strong><?= lang('deposit') . ' ' . lang('prefix') ?>
                            :</strong></label>
                </div>
                <div class="col-sm-8">
                    <p class="form-control-static"><?= (!empty($expense_info->transaction_prefix) ? $expense_info->transaction_prefix : ' ') ?></p>
                </div>
            </div>
            <div class="col-md-12 notice-details-margin">
                <div class="col-sm-4 text-right">
                                ...
                                if (!empty($v_files)):
                                    ...
                                    <li>
                                        ...
                                        <div class="mailbox-attachment-info">
                                            <a href="<?= base_url() ?>admin/transactions/download/<?= $expense_info->transactions_id . '/' . $fKey ?>"
