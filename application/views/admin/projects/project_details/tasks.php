...
<div class="box" style="border: none; " data-collapsed="0">
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
            <li class="<?= $active == 'tasks' ? 'active' : ''; ?>"><a href="#manage_task" data-toggle="tab"><?= lang('task') ?></a>
            </li>
            <?php if (!empty($edited)) { ?>
                <li class=""><a href="<?= base_url() ?>admin/tasks/create/project/<?= $project_details->project_id ?>"><?= lang('new_task') ?></a>
                </li>
            <?php } ?>
        </ul>
        <div class="tab-content bg-white">
            <!-- ************** general *************-->
            <div class="tab-pane <?= $active == 'tasks' ? 'active' : ''; ?>" id="manage_task">
