            ...
            <div class="panel-body">
                <form method="post" data-parsley-validate="" novalidate=""
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <input type="text" data-parsley-type="number" required=""
                                   class="form-control payment_amount"
                                   value="<?= $payments_info->amount ?>" name="amount">
                        </div>
                    </div>
                    <?php do_action('multicurrency_edit_payment', $payments_info); ?>
                    <div class="form-group">
                            ...
                            <div style="font-size:10pt;">
                                ...
                                <div>
                                    ...
                                    <div class="amount_received">
                                        ...
                                        <span
                                                style="font-size:16pt;display: block"><?= display_money($payments_info->amount, $currency->symbol); ?></span>
                                        <?php do_action('multicurrency_in_amount_received', $payments_info); ?>
                                    </div>
                                    <div style="clear:both;"></div>
                                    <div style="padding-top:10px">
                                        <div class="payment_details_border"><strong><a
                                                        href="<?= base_url() ?>admin/client/details/<?= $payments_info->paid_by ?>"><?= $client_name ?></a></strong>
                                        </div>
