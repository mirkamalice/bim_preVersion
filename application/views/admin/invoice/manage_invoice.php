    ...
    <div class="col-sm-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="<?= base_url('admin/invoice/createinvoice') ?>"><?= lang('create_invoice') ?></a>
                </li>
                            ...
                            <table class="table table-striped DataTables " id="DataTables" cellspacing="0" width="100%">
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function () {
                                        ...
                                        fire_datatable(base_url + "admin/invoice/invoiceList/");
                                        ...
                                        $('.filter_by').on('click', function () {
                                            ...
                                            table_url(base_url + "admin/invoice/invoiceList/" +
                                                filter_by + search_type);
                                        });
                                        <?php } ?>

                                        // for inseritng data into different div using ajax
                                    });
                                </script>
                                </tbody>
                            </table>
