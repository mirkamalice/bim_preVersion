                                    ...
                                    ?>">
                                        ...
                                        <a
                                            ...
                                            <div class="pull-right">
                                                ...
                                                ?>
                                                <?= display_money($this->invoice_model->get_invoice_cost($v_invoices->invoices_id), $currency); ?>
                                            </div>
                                            <br>
                                            <small class="block small text-muted"><?= $v_invoices->reference_no ?>
                                                <span
        ...
        <section class="panel panel-custom">
            ...
            <div class="panel-body">
                <form method="post" data-parsley-validate="" novalidate=""
                    ...
                    <?php
                    $currency = get_sales_currency($invoice_info);
                    ?>
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label "><?= lang('amount') ?> (<?= $currency->symbol ?>) <span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input type="text" required="" min="0" class="form-control payment_amount"
                                   value="<?= round($this->invoice_model->calculate_to('invoice_due', $invoice_info->invoices_id), 2) ?>"
                                   name="amount">
                        </div>
                    </div>
                    <?php do_action('base_currency_amount', $invoice_info); ?>
                    ...
                    <table class="table table-striped" cellspacing="0" width="100%">
                        ...
                        foreach ($all_payments_history as $v_payment_history) {
                            if (is_numeric($v_payment_history->payment_method)) {
                                ...
                                $payment_methods= $v_payment_history->payment_method;
                            }
