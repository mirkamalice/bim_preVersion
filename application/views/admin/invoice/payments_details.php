                                            ...
                                            foreach ($all_invoices_info as $v_invoice) {
                                                if (!empty($v_invoice)) {
                                                    ...
                                                    if (!empty($all_payment_info)) : foreach ($all_payment_info as $v_payments_info) :
                                                        ...
                                                        ?>
                                                        <li
                                                                class="<?= ($v_payments_info->payments_id == $this->uri->segment(5) ? 'active' : '') ?>">
                                                            <a
                                                                ...
                                                                <small class="block small text-info"><?= $v_payments_info->trans_id ?>
                                                                    |
                                                                    <?= strftime(config_item('date_format'), strtotime($v_payments_info->created_date)) . ' ' . display_time($v_payments_info->created_date); ?>
                                                                </small>
                            ...
                            <div style="font-size:10pt;">
                                ...
                                <div style="padding:5px;">
                                    ...
                                    <div style="width: 70%;float: left;">
                                        <div style="width: 100%;padding: 11px 0;">
                                            ...
                                            <div class="payment_details_border_semi">
                                                <?= strftime(config_item('date_format'), strtotime($payments_info->payment_date)); ?>
                                            </div>
                                            <div style="clear:both;"></div>
                                        </div>
                                        <?php do_action('multicurrency_in_payment', $payments_info); ?>
        
                                        <?php if (config_item('amount_to_words') == 'Yes') { ?>
                                            <div style="width: 100%;padding: 10px 0;">
                                                <div style="color:#999;width:35%;float:left;"><?= lang('num_word') ?></div>
                                                <div class="payment_details_border_semi">
                                                    <?= number_to_word($currency->code, $payments_info->amount) ?>
                                                </div>
                                                <div style="clear:both;"></div>
                                            </div>
                                        <?php } ?>
                                    ...
                                    <div class="amount_received">
                                        ...
                                        <span style="font-size:16pt;display: block"><?= display_money($payments_info->amount, $currency->symbol); ?></span>
                                        <?php do_action('multicurrency_in_amount_received', $payments_info); ?>
                                    </div>
                                    <div style="clear:both;"></div>
                                    <div style="padding-top:10px">
                                        <div class="payment_details_border"><strong><a
                                                        href="<?= base_url() ?>admin/client/details/<?= $payments_info->paid_by ?>"><?= $p_client_name ?></a></strong>
                                        </div>
