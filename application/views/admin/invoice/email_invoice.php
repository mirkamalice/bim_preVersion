                        ...
                        <ul class="nav"><?php
                            ...
                            <li class="<?php
                                ...
                                <?php
                                        ...
                                        ?>
                                <a
                                    href="<?= base_url() ?>admin/invoice/manage_invoice/email_invoice/<?= $v_invoices->invoices_id ?>">
                                    <?= $client_name ?>
        ...
        <div class="panel panel-custom">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post"
                    ...
                    <textarea name="message" class="form-control textarea_" id="ck_editor"><?= $message ?></textarea>
