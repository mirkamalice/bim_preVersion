    ...
    <div class="panel panel-custom">
        ...
        <div class="col-sm-9">
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <select class="form-control select_box" style="width: 100%" name="departments_id"
                        ...
                        <option
                            <?= (!empty($departments_info->departments_id) && $departments_info->departments_id == $v_departments->departments_id ? 'selected' : null) ?>
            ...
            <div class="form-group new_departments"
                ...
                <div class="col-sm-8">
                    <input <?= (!empty($departments_info->departments_id) ? 'disabled' : '') ?> type="text"
                        name="deptname" class="form-control new_departments" value="" />
                </div>
            </div>
            <div class="form-group">
                <label class=" col-sm-4 control-label"><?= lang('designation') ?><span class="required">*</span></label>
                <div class="col-sm-8">
            ...
            <table class="table table-striped" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    $(document).ready(function() {
                        ...
                        <?php } ?>
                        <?php if (
                                        $items->label == 'transfer_report' || $items->label == 'transactions_report' || $items->label == 'balance_sheet' || $items->label == 'time_history' || $items->label == 'timechange_request'
                        ...
                        <?php
                                    if (
                                        $items->label == 'performance_indicator' || $items->label == 'give_appraisal' || $items->label == 'company_details' || $items->label == 'system_settings' || $items->label == 'email_settings' || $items->label == 'email_templates' || $items->label == 'email_integration' || $items->label == 'payment_settings' || $items->label == 'invoice_settings' || $items->label == 'estimate_settings'
                                        || $items->label == 'estimate_settings' || $items->label == 'tickets_leads_settings' || $items->label == 'theme_settings' || $items->label == 'working_days'  || $items->label == 'cronjob' || $items->label == 'menu_allocation' || $items->label == 'notification'
                                        || $items->label == 'email_notification' || $items->label == 'translations' || $items->label == 'dashboard_settings' || $items->label == 'system_update'
                                    ) { ?>
                        ...
                        $("#select_all_view").change(function() { //"select all" change
                            $(".view > input").prop('checked', $(this).prop(
                        ...
                        $("#select_all_create").change(function() { //"select all" change
                            $(".create > input").prop('checked', $(this).prop(
                                "checked")); //change all ".checkbox" checked status
                        ...
                        $("#select_all_edit").change(function() { //"select all" change
                            $(".edit > input").prop('checked', $(this).prop(
                                "checked")); //change all ".checkbox" checked status
                        ...
                        $("#select_all_delete").change(function() { //"select all" change
                            $(".delete > input").prop('checked', $(this).prop(
                                "checked")); //change all ".checkbox" checked status
                        ...
                        $("#all_view_<?= $items->menu_id; ?>").change(function() { //"select all" change
                            $(".view .<?= $items->menu_id; ?>").prop('checked', $(this).prop(
                                "checked")); //change all ".checkbox" checked status
                        ...
                        $("#all_create_<?= $items->menu_id; ?>").change(function() { //"select all" change
                            $(".create .<?= $items->menu_id; ?>").prop('checked', $(this).prop(
                                "checked")); //change all ".checkbox" checked status
                        ...
                        $("#all_edit_<?= $items->menu_id; ?>").change(function() { //"select all" change
                            $(".edit .<?= $items->menu_id; ?>").prop('checked', $(this).prop(
                                "checked")); //change all ".checkbox" checked status
                        ...
                        $("#all_delete_<?= $items->menu_id; ?>").change(function() { //"select all" change
                            $(".delete .<?= $items->menu_id; ?>").prop('checked', $(this).prop(
                                "checked")); //change all ".checkbox" checked status
                        ...
                        $("#<?= $items->menu_id; ?>").change(function() { //"select all" change
                            $(".<?= $items->menu_id; ?>").prop('checked', $(this).prop(
                                "checked")); //change all ".checkbox" checked status
                        });
                        ...
                        $("#parent_<?= $items->menu_id; ?>").on("click", function() {
                    ...
                    <tr class="dept-parent">
                        ...
                        <th>
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick view" data-toggle="tooltip" data-placement="top"
                                    title="<?= lang('select_all') ?>">
                                    <input id="all_view_<?php if (!empty($parent_id)) {
                                        ...
                                        name="view_<?= $parent_id ?>" value="<?= $parent_id ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </th>
                        <th>
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick create" data-toggle="tooltip" data-placement="top"
                                    title="<?= lang('select_all') ?>">
                                    <input id="all_create_<?php if (!empty($parent_id)) {
                                        ...
                                        type="checkbox" name="created_<?= $parent_id ?>" value="<?= $parent_id ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </th>
                        <th>
                            <div class="checkbox c-checkbox">
                                <label class="needsclick edit" data-toggle="tooltip" data-placement="top"
                                    title="<?= lang('select_all') ?>">
                                    <input id="all_edit_<?php if (!empty($parent_id)) {
                                        ...
                                        name="edited_<?= $parent_id ?>" value="<?= $parent_id ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </th>
                        <th>
                            <div class="checkbox c-checkbox">
                                <label class="needsclick delete" data-toggle="tooltip" data-placement="top"
                                    title="<?= lang('select_all') ?>">
                                    <input id="all_delete_<?php if (!empty($parent_id)) {
                                        ...
                                        type="checkbox" name="deleted_<?= $parent_id ?>" value="<?= $parent_id ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </th>
                    ...
                    <tr class="dept-parent">
                        <td style="display: block;padding-left: 35px;">
                            <div id="parent_<?= $sub_chld; ?>" class="parent plus pull-left">
                                <span>X</span>
                            </div>
                            <div class="checkbox c-checkbox pull-left">
                                <label class="needsclick " data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                    ...
                                                                                    ?> class="<?= $parent_id; ?>"
                                        id="<?= $sub_chld; ?>" type="checkbox" name="menu[]" value="<?= $sub_chld; ?>">
                                    <span class="fa fa-check"></span>
                    ...
                    <tr style="background: #e2e2e2">
                        <td style="display: block;padding-left: 60px;">
                            <div id="parent_<?= $sub_chld_1; ?>" class="parent plus pull-left">
                                <span>X</span>
                            </div>
                            <div class="checkbox c-checkbox pull-left">
                                <label class="needsclick " data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                                ...
                                                                                                ?>
                                        class="<?= $parent_id . ' ' . $sub_chld; ?>" id="<?= $sub_chld_1; ?>"
                                        type="checkbox" name="menu[]" value="<?= $sub_chld_1; ?>">
                                    <span class="fa fa-check"></span>
                    ...
                    <tr class="dept-parent">
                        <td style="display: block;padding-left: 85px;">
                            <div id="parent_<?= $sub_chld_name_2; ?>" class="parent plus pull-left">
                                <span>X</span>
                            </div>
                            <div class="checkbox c-checkbox pull-left">
                                <label class="needsclick " data-toggle="tooltip" data-placement="top"
                                    title="<?= lang('select_all') ?>">
                                    <input <?php if (!empty($roll[$sub_chld_name_2])) {
                                                                                                                echo $roll[$sub_chld_name_2] ? 'checked' : '';
                                                                                                            }
                                                                                                            ?>
                                        class="<?= $parent_id . ' ' . $sub_chld . ' ' . $sub_chld_1; ?>"
                                        id="<?= $sub_chld_name_2; ?>" type="checkbox" name="menu[]"
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick " data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php if (!empty($roll[$v_sub_chld_4])) {
                                        ...
                                        type="checkbox" name="menu[]" value="<?= $v_sub_chld_4; ?>">
                                    <span class="fa fa-check"></span>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick view" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php if (!empty($roll[$v_sub_chld_4])) {
                                        ...
                                        type="checkbox" name="view_<?= $v_sub_chld_4; ?>" value="<?= $v_sub_chld_4; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                                ...
                                <label class="needsclick create" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input
                                        <?php if (!empty($roll[$v_sub_chld_4])) {
                                                                                                                    ...
                                                                                                                    ?>class="<?= $sub_chld . ' ' . $v_sub_chld_4 . ' ' . $sub_chld_name_2 . ' ' . $parent_id . ' ' . $sub_chld_1; ?>"
                                        type="checkbox" name="created_<?= $v_sub_chld_4; ?>"
                                        value="<?= $v_sub_chld_4; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick edit" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                                                    ...
                                                                                                                    ?>
                                        class="<?= $sub_chld . ' ' . $v_sub_chld_4 . ' ' . $sub_chld_name_2 . ' ' . $parent_id . ' ' . $sub_chld_1; ?>"
                                        type="checkbox" name="edited_<?= $v_sub_chld_4; ?>"
                                        value="<?= $v_sub_chld_4; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick delete" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                                                    ...
                                                                                                                    ?>
                                        class="<?= $sub_chld . ' ' . $v_sub_chld_4 . ' ' . $sub_chld_name_2 . ' ' . $parent_id . ' ' . $sub_chld_1; ?>"
                                        type="checkbox" name="deleted_<?= $v_sub_chld_4; ?>"
                                        value="<?= $v_sub_chld_4; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick " data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php if (!empty($roll[$v_sub_chld_2])) {
                                                                                                        ...
                                                                                                        ?>
                                        id="<?= $v_sub_chld_2; ?>"
                                        class="<?= $parent_id . ' ' . $sub_chld . ' ' . $sub_chld_1; ?>" type="checkbox"
                                        name="menu[]" value="<?= $v_sub_chld_2; ?>">
                                    <span class="fa fa-check"></span>
                                    <strong><?= lang($sub_chld_name_1); ?></strong>
                                </label>
                            </div>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick view" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php if (!empty($roll[$v_sub_chld_2])) {
                                        ...
                                        type="checkbox" name="view_<?= $v_sub_chld_2; ?>" value="<?= $v_sub_chld_2; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick create" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php if (!empty($roll[$v_sub_chld_2])) {
                                        ...
                                        class="<?= $sub_chld . ' ' . $parent_id . ' ' . $v_sub_chld_2 . ' ' . $sub_chld_1; ?>"
                                        type="checkbox" name="created_<?= $v_sub_chld_2; ?>"
                                        value="<?= $v_sub_chld_2; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick edit" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                        ...
                                        type="checkbox" name="edited_<?= $v_sub_chld_2; ?>"
                                        value="<?= $v_sub_chld_2; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick delete" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                                        ...
                                                                                                        ?>
                                        class="<?= $sub_chld_1 . ' ' . $sub_chld . ' ' . $v_sub_chld_2 . ' ' . $parent_id; ?>"
                                        type="checkbox" name="deleted_<?= $v_sub_chld_2; ?>"
                                        value="<?= $v_sub_chld_2; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick " data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                            ...
                                                                                            ?>
                                        id="<?= $sub_chld_id; ?>" class="<?= $parent_id . ' ' . $sub_chld; ?>"
                                        type="checkbox" name="menu[]" value="<?= $sub_chld_id; ?>">
                                    <span class="fa fa-check"></span>
                                    <strong><?= lang($sub_chld_name); ?></strong>
                                </label>
                            </div>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick view" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                        ...
                                        type="checkbox" name="view_<?= $sub_chld_id; ?>" value="<?= $sub_chld_id; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick create" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                            ...
                                                                                            ?>
                                        class="<?= $sub_chld . ' ' . $sub_chld_id . ' ' . $parent_id; ?>"
                                        type="checkbox" name="created_<?= $sub_chld_id; ?>"
                                        value="<?= $sub_chld_id; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick edit" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                            ...
                                                                                            ?>
                                        class="<?= $sub_chld . ' ' . $sub_chld_id . ' ' . $parent_id; ?>"
                                        type="checkbox" name="edited_<?= $sub_chld_id; ?>" value="<?= $sub_chld_id; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick delete" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                            ...
                                                                                            ?>
                                        class="<?= $sub_chld . ' ' . $sub_chld_id . ' ' . $parent_id; ?>"
                                        type="checkbox" name="deleted_<?= $sub_chld_id; ?>"
                                        value="<?= $sub_chld_id; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                    ...
                    <tr class="child c_<?= $parent_id; ?>">
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick " data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                ...
                                                                                ?> id="<?= $v_sub_child; ?>"
                                        class="<?= $parent_id; ?>" type="checkbox" name="menu[]"
                                        value="<?= $v_sub_child; ?>">
                                    <span class="fa fa-check"></span>
                                    <strong><?= lang($child); ?></strong>
                                </label>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick view" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                ...
                                                                                ?>
                                        class="<?= $parent_id . ' ' . $v_sub_child; ?>" type="checkbox"
                                        name="view_<?= $v_sub_child; ?>" value="<?= $v_sub_child; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick create" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                ...
                                                                                ?>
                                        class="<?= $parent_id . ' ' . $v_sub_child; ?>" type="checkbox"
                                        name="created_<?= $v_sub_child; ?>" value="<?= $v_sub_child; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                        <td>
                            <div class="checkbox c-checkbox">
                                <label class="needsclick edit" data-toggle="tooltip" data-placement="top"
                                    title="<?= lang('can') . ' ' . lang('edit') ?>">
                                    <input class="<?= $parent_id . ' ' . $v_sub_child; ?>" type="checkbox"
                                        name="edited_<?= $v_sub_child; ?>" value="<?= $v_sub_child; ?>"
                                        <?php
                                                                                                                                                                                                                if (!empty($roll[$v_sub_child])) {
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick delete" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                                                ...
                                                                                ?>
                                        class="<?= $parent_id . ' ' . $v_sub_child; ?>" type="checkbox"
                                        name="deleted_<?= $v_sub_child; ?>" value="<?= $v_sub_child; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick view" data-toggle="tooltip" data-placement="top"
                                    title="<?= lang('view_help') ?>">
                                    <input id="<?= $v_parent; ?>" <?php
                                                                                    if (!empty($roll[$v_parent])) {
                                                                                        echo $roll[$v_parent] ? 'checked' : '';
                                                                                    }
                                                                                    ?> class="<?= $v_parent; ?>"
                                        type="checkbox" name="view_<?= $v_parent; ?>" value="<?= $v_parent; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                            ...
                            <div class="checkbox c-checkbox ">
                                <label class="needsclick create" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                        ...
                                        name="created_<?= $v_parent; ?>" value="<?= $v_parent; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick edit" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                            ...
                                                            ?> class="<?= $v_parent; ?>" type="checkbox"
                                        name="edited_<?= $v_parent; ?>" value="<?= $v_parent; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
                            ...
                            <div class="checkbox c-checkbox">
                                <label class="needsclick delete" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <input <?php
                                                            ...
                                                            ?> class="<?= $v_parent; ?>" type="checkbox"
                                        name="deleted_<?= $v_parent; ?>" value="<?= $v_parent; ?>">
                                    <span class="fa fa-check"></span>
                                </label>
                            </div>
                        </td>
