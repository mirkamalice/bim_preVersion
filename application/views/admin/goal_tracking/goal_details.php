...
$comment_details = $this->db->where(array('module' => 'goal_tracking', 'module_field_id' => $goal_info->goal_tracking_id))->get('tbl_task_comment')->result();
    ...
    <div class="col-sm-2">
        ...
        <ul class="nav nav-pills nav-stacked navbar-custom-nav">
            ...
            <li class="<?= $active == 6 ? 'active' : '' ?>"><a href="#activities"
                    data-toggle="tab"><?= lang('activities') ?><strong class="pull-right"></strong><strong
                    ...
                    <div class="panel-heading">
                        <div class="panel-title"><strong><?= $goal_info->subject ?> - <?= lang('details') ?> </strong>
                            ...
                            <div class="col-sm-2 pull-right">
                                <a href="<?php echo base_url() ?>admin/goal_tracking/create/<?= $goal_info->goal_tracking_id ?>"
                            ...
                            <div class="text-center block mt-lg">
                                <div style="display: inline-block">
                                    <div id="easypie3" data-percent="<?= $progress['progress'] ?>"
                                        data-bar-color="#<?= $prgs ?>" class="easypie-chart">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <textarea class="form-control textarea"
                                        placeholder="<?= $goal_info->subject . ' ' . lang('comments') ?>" name="comment"
                ...
                <div class="box" style="border: none; padding-top: 15px;" data-collapsed="0">
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <?php if (!empty($edited)) { ?>
                            <li class=""><a
                                    href="<?= base_url() ?>admin/tasks/create/goal/<?= $goal_info->goal_tracking_id ?>"><?= lang('new_task') ?></a>
                            </li>
                            <?php } ?>
                        </ul>
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><?= lang('activities') ?>
                            ...
                            <span class="btn-xs pull-right">
                                <a
                                    href="<?= base_url() ?>admin/tasks/claer_activities/goal_tracking/<?= $goal_info->goal_tracking_id ?>"><?= lang('clear') . ' ' . lang('activities') ?></a>
                            </span>
                            <?php } ?>
                        </h3>
                    </div>
