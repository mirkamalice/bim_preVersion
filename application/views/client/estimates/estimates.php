...
// print('<pre>'.print_r($all_estimates,true).'</pre>'); exit;
                ...
                <div class="pl-sm pr-sm pb-sm">
                    <strong><a class="text-primary filter_by" style="font-size: 15px"
                        ...
                        <small class="pull-right " style="padding-top: 2px"> <?= $sent ?>
                            / <?= count(array($all_estimates)) ?></small>
                    </strong>
                    <div class="progress progress-striped progress-xs mb-sm">
                        <div class="progress-bar progress-bar-aqua " data-toggle="tooltip"
                             data-original-title="<?= ($sent / count(array($all_estimates))) * 100 ?>%"
                             style="width: <?= ($sent / count(array($all_estimates))) * 100 ?>%"></div>
                    </div>
                </div>
            </div>
            <!-- END widget-->
                ...
                <div class="pl-sm pr-sm pb-sm">
                    ...
                    <div class="progress progress-striped progress-xs mb-sm">
                        <div class="progress-bar progress-bar-primary " data-toggle="tooltip"
                             data-original-title="<?= ($expired / count(array($all_estimates))) * 100 ?>%"
                             style="width: <?= ($expired / count(array($all_estimates))) * 100 ?>%"></div>
                    </div>
                </div>
            </div>
            <!-- END widget-->
        ...
        <div class="col-lg-3">
            ...
            <div class="panel widget">
                <div class="pl-sm pr-sm pb-sm">
                    ...
                    <div class="progress progress-striped progress-xs mb-sm">
                        <div class="progress-bar progress-bar-primary " data-toggle="tooltip"
                             data-original-title="<?= ($declined / count(array($all_estimates))) * 100 ?>%"
                             style="width: <?= ($declined / count(array($all_estimates))) * 100 ?>%"></div>
                    </div>
                </div>
            </div>
            <!-- END widget-->
                ...
                <div class="pl-sm pr-sm pb-sm">
                    ...
                    <div class="progress progress-striped progress-xs mb-sm">
                        <div class="progress-bar progress-bar-warning " data-toggle="tooltip"
                             data-original-title="<?= ($accepted / count(array($all_estimates))) * 100 ?>%"
                             style="width: <?= ($accepted / count(array($all_estimates))) * 100 ?>%"></div>
                    </div>
                </div>
            </div>
            <!-- END widget-->
