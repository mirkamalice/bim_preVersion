...
$comment_details = $this->db->where('module_field_id', $task_details->module_field_id)->get('tbl_task_comment')->result();
                    ...
                    <div class="panel panel-custom">
                        ...
                        <div class="panel-body">
                            ...
                            if (!empty($add_files_info)) {
                                echo $add_files_info->attachments_id;
                            }
                                                       ...
                                                       aria-controls="collapseOne">
                                                        ...
                                                        <small style="color:#ffffff " class="pull-right">
                                                            <?php if ($files_info[$key]->user_id == $this->session->userdata('user_id')) { ?>
                                                                <?= btn_delete('client/tasks/delete_task_files/' . $files_info[$key]->task_id . '/' . $files_info[$key]->attachments_id) ?>
                                                            <?php } ?></small>
                                                    </a>
                                                </h4>
                                            </div>
